        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Ready to transform your waste streams into valuable bio-aromatics? 
              Let's discuss how Carboform can help decarbonize your operations.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            animationDelay: "0.2s"
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-muted-foreground">info@carboform.com</span>
                  </div>
                  <div className="flex items-center gap-3">
              ...
              <Card className="bg-gradient-subtle border-border/50">
                <CardHeader>
                  <CardTitle className="text-xl">Why Partner with Carboform?</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                    <p className="text-sm text-muted-foreground">
                      Transform waste streams into valuable bio-aromatics
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                    <p className="text-sm text-muted-foreground">
                      Reduce carbon footprint while creating new revenue streams
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                    <p className="text-sm text-muted-foreground">
                      Proven technology backed by leading research institutions
                    </p>
                  </div>
                </CardContent>
              </Card>
